...
async def check_flag_locations(client: "PokemonTHTOriginsClient", ctx: "BizHawkClientContext") -> list[int]:
...
async def check_dex_locations(client: "PokemonTHTOriginsClient", ctx: "BizHawkClientContext") -> list[int]:
