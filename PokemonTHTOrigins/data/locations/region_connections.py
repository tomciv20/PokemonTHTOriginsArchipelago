...
connections: dict[str, RegionConnectionData] = {
    ...
    "Dreamyard traffic cone": RegionConnectionData("Dreamyard Entrance", "Dreamyard Basement", None),
    "Dreamyard basement south": RegionConnectionData("Dreamyard Basement", "Dreamyard South", None),
    "Striaton City west": RegionConnectionData("Striaton City", "Route 3", None),
    ...
    "Enter Pinwheel Forest": RegionConnectionData("Pinwheel Forest Outside", "Pinwheel Forest West", None),
    ...
    "Route 4 worker": RegionConnectionData("Route 4 South", "Route 4 North", None),
    ...
    "Relic Castle B2F castleside": RegionConnectionData("Relic Castle Entrance", "Relic Castle Lower Floors", None),
    ...
    "Route 5 west": RegionConnectionData("Route 5", "Driftveil Drawbridge", None),
    ...
    "Driftveil City east": RegionConnectionData("Driftveil City", "Driftveil Drawbridge", None),
